...
from das.data.transforms.random_rescale import RandomRescale
from das.data.transforms.rescale import Rescale

from .utils.common import TrainValSamplingStrategy


class ImageRescaleStrategyEnum(str, Enum):
    RESCALE_SIMPLE = 'rescale_simple'
    RESCALE_RANDOM = 'rescale_random'


@dataclass
class ImageRescaleStrategy:
    name: str
    params: dict

    def __post_init__(self):
        self.name = ImageRescaleStrategyEnum(self.name)

    def create(self):
        if self.name == ImageRescaleStrategyEnum.RESCALE_SIMPLE:
            return Rescale(**self.params)
        elif self.name == ImageRescaleStrategyEnum.RESCALE_RANDOM:
            return RandomRescale(**self.params)
...
class DataLoaderArguments:
    ...
    shuffle_data: bool = field(
        ...
        metadata={
            "help": (
                "Whether to shuffle the data on load or not.")})
    pin_memory: bool = field(
        default=False,
        metadata={
            "help": (
                "Whether to load data into pinned memory")})
    ...
    aspect_ratio_grouping_factor: int = field(
        ...
        metadata={
            "help": (
                "The size of the groups for aspect ratio grouping.")
        })
...
class DataTokenizationArguments:
    ...
    tokenizer_lib: Optional[str] = field(
        ...
        metadata={
            "help": (
                "The name of the tokenizer library, torchtext or huggingface")
        })
    ...
    max_seqs_per_sample: int = field(
        default=5,
        metadata={
            "help": "Max number of seqeunces per sample."
        })
    compute_word_to_toke_maps: bool = field(
        default=False,
        metadata={
            "help": "Whether to compute word to token mapping."
        })
...
class DataCachingArguments:
    use_datadings: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "Whether to use datadings to store the data into cache.")
        })
    cache_resized_images: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to cache images after resizing them to small size."
        })
    cache_image_size: Optional[Union[list]] = field(
        default_factory=lambda: [224, 224],
        metadata={
            "help": (
                "Image size to rescale to if caching is wanted.")
        })
    load_data_to_ram: Optional[bool] = field(
        default=False,
        metadata={
            "help": (
                "Whether to load data into RAM or read directly from datadings.")
        })
    cached_data_name: Optional[str] = field(
        default=None,
        metadata={
            "help": (
                "The name of the cached_data file.")
        })
    dataset_cache_dir: Optional[str] = field(
        default=None,
        metadata={
            "help": "Where do you want to store the dataset files."
        })
...
class DataSplittingArguments:
    ...
    random_split_ratio: float = field(
        default=0.8,
        metadata={
            "help": "The train/validation dataset split ratio."
        })
    k_folds: int = field(
        default=5,
        metadata={
...
class DataTransformsArguments:
    train_image_rescale_strategy: Optional[ImageRescaleStrategy] = field(
        ...
        metadata={
            "help": (
                "The image rescaling splitting strategy to use for train set.")
        })
    ...
    convert_rgb_to_bgr: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to convert RGB image to BGR image."
        })
    ...
    dataset_std: Optional[Union[list, dict]] = field(
        ...
        metadata={
            "help": (
                "Possible andom scale dims for shorter dims.")
        })
...
class DataArguments:
    ...
    dataset_dir: Optional[str] = field(
        default=None,
        metadata={
            "help": "The path to the directory of the dataset."
        })
    data_caching_args: DataCachingArguments = field(
        default=DataCachingArguments(),
        metadata={
            "help": (
                "Arguments related to data caching.")
        })
    data_splitting_args: Optional[DataSplittingArguments] = field(
        default=None,
        metadata={
            "help": (
                "Arguments related to data test/val splitting")
        })
    data_transforms_args: Optional[DataTransformsArguments] = field(
        default=None,
        metadata={
            "help": (
                "Arguments related to defining default data transformations.")
        })
    ...
    data_tokenization_args: DataTokenizationArguments = field(
        ...
        metadata={
            "help": (
                "Arguments related to data tokenization.")
        })
    ...
    def __post_init__(self):
        if self.data_tokenization_args.tokenize_dataset is True and \
                self.data_tokenization_args.tokenizer_name is None:
            raise ValueError(
                "Please provide tokenizer name if dataset is to be tokenized."
            )
        if self.data_splitting_args is not None and \
                self.data_splitting_args.train_val_sampling_strategy is not None:
