...
def tokenize_sample(sample, data_args):
    ...
    if data_args.data_tokenization_args.overflow_samples_combined:
        ...
        sample[DataKeysEnum.TOKEN_IDS] = tokenized_data[DataKeysEnum.TOKEN_IDS]
        sample[DataKeysEnum.ATTENTION_MASKS] = tokenized_data[
            DataKeysEnum.ATTENTION_MASKS
        ]
        sample[DataKeysEnum.TOKEN_TYPE_IDS] = tokenized_data[
