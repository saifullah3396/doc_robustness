...
class DataCacher:
    ...
    def data_file_name(self):
        ...
        if self.data_args.data_tokenization_args.tokenize_dataset:
            filename += ".tokenized"
...
class DatadingsDataCacher(DataCacher):
    ...
    def save_to_cache(self, dataset):
        ...
        if dataset.data is not None:
            ...
            try:
                ...
                # start writing to datadings
                with CustomFileWriter(self.file_path, overwrite=False) as writer:
                    logger.info(
    ...
    def save_dataset_meta(self, dataset):
        ...
        dataset_meta_fp = self.file_path.parent / "dataset_meta.pickle"
    ...
    def validate_cache(self):
        try:
            ...
            if dataset_meta is None:
                print("dataset_meta_fp does not exist")
                return False
